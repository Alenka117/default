    ...
    <div class="container">
        ...
        <form class="form-horizontal" role="form" action="../formHandler.php" method="post">
            <div class="form-group">
                <label class="control-label col-sm-3" for="author[id]"><?php _e("AUTHOR_ADD_ID"); ?></label>
                <div class="col-sm-6">
                    <input class="form-control" name="author[id]" type="text" size="30">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="form-control" name="author[deceased]" type="date" size="4" required>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="author[created_at]"><?php _e("AUTHOR_ADD_CREATED_AT"); ?></label>
                <div class="col-sm-6">
                    <input class="form-control" name="author[created_at]" type="date" size="4" required>
                </div>
            </div>
            <div class="form-group">
